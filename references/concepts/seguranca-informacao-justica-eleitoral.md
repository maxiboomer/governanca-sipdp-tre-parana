---
title: Segurança Informação Justiça Eleitoral
type: concept
created: 2024-01-15
updated: 2026-08-04
tags: [psi, seguranca, eleitoral, tribel-pr]
---

# Segurança da Informação na Justiça Eleitoral

## Hub Central

Esta nota serve como hub para a análise jurídico-normativa consolidada de Proteção de Segurança da Informação, LAI, PGPPDP, governança e crises na Justiça Eleitoral.
...
1. **Ataques cibernéticos** - Malware, ransomware
2. **Vazamento de dados** - LGPD aplicável
3. **Interferência eleitoral** - Segurança absoluta
4. **Degradação de serviços** - DoS, DDoS

## Métricas de Segurança

| Métrica | Target | Fonte |
|---------|--------|-------|
| Tempo de resposta a incidentes | < 2h | ETIR |
| Disponibilidade de serviços | 99.9% | SI |
