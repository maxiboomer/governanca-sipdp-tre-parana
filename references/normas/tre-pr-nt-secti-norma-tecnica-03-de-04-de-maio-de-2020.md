...
sources: [raw/tre-pr-nt-secti-norma-tecnica-03-de-04-de-maio-de-2020.md]
tags: [norma, tre-pr]
---
...
Norma vigente do acervo, relevante para segurança da informação, proteção de dados ou governança de TI no TRE-PR/Justiça Eleitoral. **Situação registrada:** `vigente`. Síntese extraída do texto integral em `raw/tre-pr-nt-secti-norma-tecnica-03-de-04-de-maio-de-2020.md`.
...
- Esta é uma página de índice analítico; a fonte de verdade é o texto integral em `raw/tre-pr-nt-secti-norma-tecnica-03-de-04-de-maio-de-2020.md`.
...
- Fonte integral: `raw/tre-pr-nt-secti-norma-tecnica-03-de-04-de-maio-de-2020.md`
