---
title: "Portaria DG TRE-PR 124/2026 — CETI (atribuições)"
name: "Portaria DG TRE-PR 124/2026 — CETI (atribuições)"
created: 2026-08-29
updated: 2026-08-29
...
- **Art. 1º** Designa os servidores que compõem o Comitê Executivo de Tecnologia da Informação
  (CETI), sob a Coordenação de Gilmar Jose Fernandes de Deus (Secretário de Tecnologia da Informação).
- **Art. 2º** Fixa as **atribuições do CETI** (12 incisos): envolver a alta administração em decisões
  estratégicas de TIC; aprovar planos táticos/operacionais; monitorar execução orçamentária e
  financeira de TIC; planejar/priorizar/monitorar contratações de TIC; acompanhar iniciativas
  estratégicas; apoiar escritório de projetos; definir carteira de projetos e gestão de portfólio
  de serviços de TIC; plano de ação para iniciativas de curta duração; recomendar/adotar boas
  práticas; propor modelos e padrões de Governança de TIC; promover participação coletiva na
  elaboração de propostas; analisar/organizar/estruturar o atendimento das demandas de TIC.
- **Art. 3º** Reuniões ordinárias quinzenais; extraordinárias quando necessário.
- **Art. 4º** **REVOGA a Portaria DG 425/2018 e a Portaria DG 502/2022.**
- **Art. 5º** Vigência a partir da publicação (DJE-TRE-PR nº 050, 19/03/2026, p. 11-12).

Fundamenta-se no art. 8º da Resolução CNJ nº 370/2021 (Comitê de Gestão de TIC) e no Regulamento
da Secretaria (Res. TRE-PR 971/2026).
...
- Revoga: Portaria DG 425/2018 (instituição do CETI) e Portaria DG 502/2022 (comitê executivo de
  ...
  de composição e atribuições do CETI.
