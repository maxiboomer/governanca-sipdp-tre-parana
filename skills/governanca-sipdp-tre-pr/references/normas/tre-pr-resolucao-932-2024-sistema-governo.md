...
sources: [references/raw/tre-pr-resolucao-932-2024-sistema-governo.md]
tags: [norma, tre-pr]
---
...
Norma vigente do acervo, relevante para segurança da informação, proteção de dados ou governança de TI no TRE-PR/Justiça Eleitoral. **Situação registrada:** `vigente`. Síntese extraída do texto integral em `references/raw/tre-pr-resolucao-932-2024-sistema-governo.md`.
...
- Esta é uma página de índice analítico; a fonte de verdade é o texto integral em `references/raw/tre-pr-resolucao-932-2024-sistema-governo.md`.
...
- Fonte integral: `references/raw/tre-pr-resolucao-932-2024-sistema-governo.md`
