...
§ 1º Os recursos de tecnologia da informação e comunicação pertencentes aos órgãos da Justiça Eletral e disponíveis aos usuários devem ser utilizados exclusivamente em atividades institucionais.
...
**Art. 8º** Os destinatários desta PSI, relacionados no caput do art. 7º, são corresponsáveis pela segurança da informação, de acordo comos preceitos estabelecidos nesta Resolução, e têm como deveres:
...
II - Nível Tático: Normas Complementares sobre Segurança da Informação, que contemplam obrigações a serem seguidas conforme as diretrizes estabelecidas nesta PSI, as quais deverão ser editadas por todos os tribunais que compõem a Justiça Eleitoral e abarcarão, no mínimo, os seguintes temas:
...
Parágrafo único. Os projetos e as aquisições relacionadas à segurança da informação deverão ser priorizados a partir dos riscos levantados por meio das metodologias formais dos tribunais.
...
IV - realizar ações periódicas de sensibilização, campanhas educativas e exercícios práticos, incluindo relacionados à prevenção de engenharia social e à resposta a incidentes;
...
VIII - integração com indicadores de incidentes envolvendo dados pessoais, em articulação com o Encarregado de Dados e com o CGPD, resguardada a confidencialidade das informações sensíveis.
...
**Art. 17.** A Estrutura de Gestão da Segurança da Informação compreende o conjunto de instâncias, papéis e responsabilidades instituídas para planejar, coordenar, executar e acompanhar as ações de segurança da informação no âmbito da Justiça Eleitoral, com vistas à proteção dos ativos informacionais, à mitigação de riscos e ao fortalecimento da governança institucional.
...
X - representar o tribunal eleitoral nos contatos com entidades externas necessários ao tratamento de incidentes de segurança da informação, a exceção dos casos atribuídos à ETIR;
...
IV - nomear ou delegar ao(a) Diretor(a)-Geral da Secretaria a nomeação dos integrantes da ETIR, indicados pelo(a) Secretário(a) de Tecnologia da Informação.

**Art. 26.** Compete ao(a) Diretor(a)-Geral da Secretaria do Tribunal:
...
Parágrafo único. As diretrizes normativas de que trata o caput deste artigo também devem ser divulgadas a todos os citados no art. 7º no momento da sua posse/admissão, além de outras pessoas que se encontrem a serviço ou em visita às unidades do Tribunal, autorizadas a utilizar temporariamente os recursos de tecnologia da informação e comunicação da instituição.
...
---
**Nota:** Este texto não substitui o publicado no DJE-TSE, nº 96, de 15.6.2026, p. 118-129.